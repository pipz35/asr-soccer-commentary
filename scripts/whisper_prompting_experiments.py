...
TEST_GAMES = [
    {
        ...
        "roster": (
            "Mignolet, Clyne, Sakho, Lovren, Moreno, Can, Henderson, Lallana, "
            "Coutinho, Firmino, Sturridge, "
            "Hart, Sagna, Otamendi, Mangala, Clichy, Fernando, Fernandinho, "
            "Toure, Navas, Sterling, Aguero"
        ),
    },
    {
        ...
        "roster": (
            ...
            "Walcott, Ozil, Iwobi, Alexis Sanchez, "
            "Courtois, Azpilicueta, David Luiz, Cahill, Moses, Kante, Matic, "
            "Pedro, Willian, Hazard, Diego Costa"
        ),
    },
    {
        ...
        "roster": (
            ...
            "Rakitic, Iniesta, Messi, Suarez, Neymar, "
            "Neuer, Rafinha, Boateng, Benatia, Bernat, Alonso, Lahm, "
            "Schweinsteiger, Muller, Robben, Lewandowski"
        ),
    },
    {
        ...
        "roster": (
            "Mandanda, Fanni, Nkoulou, Morel, Mendy, Imbula, Lemina, "
            "Payet, Cabella, Ayew, Gignac, "
            "Sirigu, Van der Wiel, Marquinhos, Thiago Silva, Maxwell, "
            "Verratti, Matuidi, Rabiot, Lucas, Pastore, Cavani, Lavezzi"
        ),
    },
]
